...
<script src='ThemeBlue/js/forkit.js' type="text/javascript"></script>



<script src='ThemeGreen/js/snap.svg-min.js'></script>
<script src='ThemeGreen/SpryAssets/SpryTabbedPanels.js' type='text/javascript'></script>
...
<script type='text/javascript' src='ThemeGreen/js/modernizr.custom.28468.js'></script>
<script src='ThemeGreen/js/modernizr.js' type="text/javascript"></script>
<script src='ThemeGreen/js/forkit.js' type="text/javascript"></script>





<script src='ThemePink/js/forkit.js' type="text/javascript"></script>
<script src='ThemePink/js/snap.svg-min.js'></script>
<script src='ThemePink/SpryAssets/SpryTabbedPanels.js' type='text/javascript'></script>
<script type='text/javascript' src='ThemePink/js/modernizr.custom.28468.js'></script>
<script src='ThemePink/js/modernizr.js' type="text/javascript"></script>
...
var include=function(path){path="http://localhost/digitologynew/ThemePink/js/"+path;document.Echo('');};
//var tabs=function(path){path="http://localhost/digitologynew/ThemePink/SpryAssets/"+path;document.Echo('');};
alert(include("forkit.js"));
include("forkit.js");
include("classie.js");
include("main4.js");
include("classie.js");
...
include("modernizr.custom.28468.js");
include("main.js");
tabs("SpryTabbedPanels.js");
include("jquery.cslider.js");
...
$(document).ready(function () {  
  var allBoxes = $("div.themes").children("b"); 
...
function transitionBox(from, to) {
    function next() {
        var nextTo;
        if (to.is(":last-child")) {
            nextTo = to.closest(".themes").children("b").first();
        } else {
            nextTo = to.next();
        }
        to.fadeIn(500, function () {
         ...
         if($('#ThemeBlue').css('display') == 'inline'){
			// alert('blue');
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/Template.css' />"));
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/Search.css' />")); 
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/normalize.css' />")); 
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/demo.css' />")); 
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/fonts/font-awesome-4.2.0/css/font-awesome.min.css' />"));
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/menu_bubble.css' />"));
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/animate.css' />"));
		 $("head").append($("<link href='http://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic' rel='stylesheet' type='text/css'>"));
	     $("head").append($("<link href='ThemeBlue/css/forkit.css' rel='stylesheet' type='text/css'>")); 
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/font-awesome.css' />")); 
		 $("head").append($("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Raleway:400,800,300' />")); 
	 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/normalize.css' />")); 
	   $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/demo.css' />")); 
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/set1.css' />")); 
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/style2.css' />")); 
		 $("head").append($("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Economica:700,400italic' />"));  
		 $("head").append($("<noscript><link rel='stylesheet' type='text/css' href='ThemeBlue/css/nojs.css' /></noscript>"));
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/css/style.css' />"));
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeBlue/SpryAssets/SpryTabbedPanels.css' />"));
		
        }else{
			/* $('link[href="ThemeBlue/css/Template.css"]').prop("disabled", true);  
			  $('link[href="ThemeBlue/css/Search.css"]').prop("disabled", true);   
			    $('link[href="ThemeBlue/css/forkit.css"]').prop("disabled", true); 
				 $('link[href="ThemeBlue/css/normalize.css"]').prop("disabled", true);  
			  $('link[href="ThemeBlue/css/demo.css"]').prop("disabled", true);   
			    $('link[href="ThemeBlue/css/menu_bubble.css"]').prop("disabled", true); 
				   $('link[href="ThemeBlue/css/SpryTabbedPanels.css"]').prop("disabled", true); 
				    $('link[href="ThemeBlue/css/SpryTabbedPanels.css"]').prop("disabled", true); */
			//$('#ThemeBlue').css('display','none');
			}
		
	if($('#ThemeGreen').css('display') == 'inline'){
		//alert("Green");
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/Template.css' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/animate.css' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italics' />")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/forkit.css' />")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/font-awesome.css' />")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Raleway:400,800,300' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/normalize.css' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/demo.css' />"));
		  $("head").append($("<link href='ThemeGreen/css/set1.css' rel='stylesheet' type='text/css'>"));
		  $("head").append($("<link href='ThemeGreen/css/style2.css' rel='stylesheet' type='text/css'>")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Economica:700,400italic' />")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/nojs.css' />")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/style.css' />"));  
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/SpryAssets/SpryTabbedPanels.css' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/global.1291388306.css' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/home.1291388306.css' />"));
		    $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/ menu_bubble.css' />"));
                $("head").append($("<link rel='stylesheet' type='text/css' href='ThemeGreen/css/nojs.css' />"));
			...
			$('#ThemeGreen').css('display','none');
			}
	 if($('#ThemePink').css('display') == 'inline'){
		 $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/Template.css' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/Search.css' />")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/normalize.css' />")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/demo.css' />")); 
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/fonts/font-awesome-4.2.0/css/font-awesome.min.css' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/menu_bubble.css' />"));
		  $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/animate.css' />"));
		  $("head").append($("<link href='http://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic' rel='stylesheet' type='text/css'>"));
		   $("head").append($("<link href='ThemePink/css/forkit.css' rel='stylesheet' type='text/css'>")); 
		   $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/font-awesome.css' />")); 
		   $("head").append($("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Raleway:400,800,300' />")); 
		   $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/set1.css' />"));  
		   $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/style2.css' />"));
		   $("head").append($("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Economica:700,400italic' />"));
		   $("head").append($("<noscript><link rel='stylesheet' type='text/css' href='ThemePink/css/nojs.css' /></noscript>")); 
		   $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/css/style.css' />")); 
		   $("head").append($("<link rel='stylesheet' type='text/css' href='ThemePink/SpryAssets/SpryTabbedPanels.css' />"));
        }
		else{
			$('#ThemePink').css('display','none');
			}
    }
...
<a href="#0" class="cd-top">Top</a>
      ...
      <!--<div style="color:#00F;">text 1</div>-->
    </b>
    <b id="ThemeGreen">
    <script src='ThemeGreen/js/main.js' type="text/javascript"></script>
    <div class="container">
     <!-- Menu -->
			<div class="menu-wrap">
				<nav class="menu">
...
<a href="#0" class="cd-top">Top</a>
     ...
     <!--<div style="color:#060;">text 2</div>-->
    </b>
    <b id="ThemePink">
    <div class="container">
           <!-- Menu -->
...
<a href="#0" class="cd-top">Top</a>
   ...
   <!--<div style="color:#F0F;">text 3</div>-->
    </b>
</div>
 <!--Menu-->
		<script src="ThemeGreen/js/classie.js"></script>
        <script src="ThemeBlue/js/classie.js"></script>
        <script src="ThemePink/js/classie.js"></script>
		<script src="ThemeGreen/js/main4.js"></script>
        <script src="ThemeBlue/js/main4.js"></script>
        <script src="ThemePink/js/main4.js"></script>
    
        <!--Menu End-->
        <!--- FallDown Div --->
        <script src="ThemePink/js/forkit.js"></script>
         <script src="ThemeBlue/js/forkit.js"></script>
         <script src="ThemeGreen/js/forkit.js"></script>
        <!--- FallDown Div End --->
    <!--- Expender --->
        <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
           <script type="text/javascript">
  ...
  <script src="ThemePink/js/readmore.js"></script>
   <script src="ThemeBlue/js/readmore.js"></script>
    <script src="ThemeGreen/js/readmore.js"></script>
...
<!-- Testimonals -->
		...
		<script type="text/javascript" src="ThemePink/js/jquery.cslider.js"></script>
        	<script type="text/javascript" src="ThemeBlue/js/jquery.cslider.js"></script>
            <script type="text/javascript" src="ThemeGreen/js/jquery.cslider.js"></script>
...
<!--- Social Container -->
 ...
 <!--- Social Container End --->
 <!-- Page Scroll -->
<script src="ThemeGreen/js/main5.js"></script> <!-- Gem jQuery -->
<script src="ThemeBlue/js/main5.js"></script>
<script src="ThemePink/js/main5.js"></script>
        <!-- Page Scroll End -->
<!--- Tabeed Mobile --->     
<script type="text/javascript">
<!--
var TabbedPanels1 = new Spry.Widget.TabbedPanels("TabbedPanels1");
var TabbedPanels12 = new Spry.Widget.TabbedPanels("TabbedPanels11");
