...
<script type='ThemeBlue/text/javascript' src='js/modernizr.custom.28468.js'></script>
<script src='ThemeBlue/js/modernizr.js'></script>
...
$(document).ready(function () {
    var allBoxes = $("span.themes").children("span");
...
function transitionBox(from, to) {
    function next() {
        var nextTo;
        if (to.is(":last-child")) {
            nextTo = to.closest(".themes").children("span").first();
        } else {
            nextTo = to.next();
        }
        ...
        }else if($('#ThemeBlue').css('display') == 'none'){
	...
	if($('#ThemeGreen').css('display') == 'inline'){
        ...
        }else if($('#ThemeGreen').css('display') == 'none'){
	 ...
	 if($('#ThemePink').css('display') == 'inline'){
        ...
        }else if($('#ThemePink').css('display') == 'none'){
