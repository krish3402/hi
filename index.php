...
<script type="text/javascript" src='ThemeBlue/js/snap.svg-min.js'></script>
 ...
 <script type="text/javascript">
  $(document).ready(function () {
    ...
    function showDiv(num) {
		...
		/* $("head").append($("<script type='text/javascript' src='ThemeBlue/js/snap.svg-min.js'>"));
		 $("head").append($("<script type='text/javascript' src='ThemeBlue/SpryAssets/SpryTabbedPanels.js'>"));
         $("head").append($("<script type='text/javascript' src='ThemeBlue/js/modernizr.custom.28468.js'>"));
         $("head").append($("<script type='text/javascript' src='ThemeBlue/js/modernizr.js'>")); */
		 var blueForkit = document.createElement( 'script' );
			blueForkit.type = 'text/javascript';
			blueForkit.src = 'js/forkit.js';
			blueForkit.id = 'blue20';
			$("#fallDownScript").append( blueForkit );
		...
		$('#green20').remove();
		  ...
		  $("head").append($("<link id='green5' rel='stylesheet' type='text/css' href='ThemeGreen/fonts/font-awesome-4.2.0/css/font-awesome.min.css' />")); 
		 ...
		 /*$("head").append($("<script type='text/javascript' src='ThemeGreen/js/snap.svg-min.js'>"));
		 $("head").append($("<script type='text/javascript' src='ThemeGreen/SpryAssets/SpryTabbedPanels.js'>"));
         $("head").append($("<script type='text/javascript' src='ThemeGreen/js/modernizr.custom.28468.js'>"));
         $("head").append($("<script type='text/javascript' src='ThemeGreen/js/modernizr.js'>"));
		 $("head").append($("<script src='ThemeGreen/js/jquery.1291388341.js' type='text/javascript'>"));
		 $("head").append($("<script src='ThemeGreen/js/global.1291388332.js' type='text/javascript'>"));
		 $("head").append($("<script src='ThemeGreen/js/jquery.easing.1291388340.js' type='text/javascript'>"));
		 $("head").append($("<script src='ThemeGreen/js/home.1291388333.js' type='text/javascript'>"));
		 $("head").append($("<script src='ThemeGreen/js/cufon.1291388330.js' type='text/javascript'>"));
		 $("head").append($("<script src='ThemeGreen/js/Garamond3_400-Garamond3_italic_400.font.js' type='text/javascript'>"));*/
		  var greenForkit = document.createElement( 'script' );
			greenForkit.type = 'text/javascript';
			greenForkit.src = 'js/greenforkit.js';
			greenForkit.id = 'green20';
			$("#fallDownScript").append(greenForkit);
		   $('#blue1').remove();
		$('#blue2').remove();
		$('#blue3').remove();
		$('#blue4').remove();
		...
		$('#pink20').remove();
		  ...
		  $("head").append($("<link id='pink5' rel='stylesheet' type='text/css' href='ThemePink/fonts/font-awesome-4.2.0/css/font-awesome.min.css' />"));
		   $("head").append($("<link id='green4' rel='stylesheet' type='text/css' href='ThemePink/css/forkit.css' />")); 
		  ...
		  $("head").append($("<link id='pink8' href='http://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic' rel='stylesheet' type='text/css'>"));
		   ...
		   $("head").append($("<link id='pink18' rel='stylesheet' type='text/css' href='ThemePink/SpryAssets/SpryTabbedPanels.css' />"));
		    $("head").append($("<script type='text/javascript' src='ThemePink/js/snap.svg-min.js'>"));
		 $("head").append($("<script type='text/javascript' src='ThemePink/SpryAssets/SpryTabbedPanels.js'>"));
         $("head").append($("<script type='text/javascript' src='ThemePink/js/modernizr.custom.28468.js'>"));
         $("head").append($("<script type='text/javascript' src='ThemePink/js/modernizr.js'>"));
		   var pinkForkit = document.createElement( 'script' );
			pinkForkit.type = 'text/javascript';
			pinkForkit.src = 'js/pinkforkit.js';
			pinkForkit.id = 'pink20';
			$("#fallDownScript").append(pinkForkit);
		   $('#blue1').remove();
		$('#blue2').remove();
		$('#blue3').remove();
		$('#blue4').remove();
 ...
 <div class="BtnWraper BtnMargin">
      ...
      <div class="col-md-5 grid-right wow fadeInRight animated" data-wow-delay="1.6s">
        ...
        <p class="NormalText NormalPcolor">Digitology is a global IT solutions company with over 6 year's experience. We provide full-cycle services in the areas of software development, Web-based enterprise solutions, Web application and portal development. We combine our solid business domain experience, technical expertise, profound knowledge of latest industry trends and quality-driven delivery model to offer progressive, end-to-end Web solutions.</p></div>
            ...
            <div class="HexagonIcon"><img src="ThemeBlue/images/Discover.png"></div>
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemeBlue/images/Design.png"></div>
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemeBlue/images/develop.png"></div>
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemeBlue/images/deploy.png"></div>
           ...
           <div class="grid">
					<figure class="effect-sadie">
						<img src="ThemeBlue/images/DesignServices.jpg" alt="img02" width="100%"/>
						<figcaption>
					...
					<figure class="effect-sadie">
						<img src="ThemeBlue/images/Develop.jpg" alt="img14" width="100%"/>
						<figcaption>
                    	...
                    	<figure class="effect-sadie">
						<img src="ThemeBlue/images/DevelopServices.png" alt="img14" width="100%"/>
						<figcaption>
...
<span class="ServicesRegTxt">Losum Dummy, Losum Dummy
                    	...
                    	<figure class="effect-sadie">
						<img src="ThemeBlue/images/Dashboard.jpg" alt="img14" width="100%"/>
						<figcaption>
...
<a href="#0" class="cd-top">Top</a>
  ...
  <input id="search" name="search" type="text" placeholder="looking for ?"><input id="search_submit" value="Rechercher" type="submit">
   ...
   <!-- FallDown Div -->
   <!-- The contents (if there's no contents the ribbon acts as a link) -->
    	<div class="green-forkit-curtain">
			<div class="close-buttonz"></div>
            <!--- Content Place Holder -->
            <div class="ContactInnerContainer">
            <!--- Contact Left Container -->
...
<div class="ContactSubTitleWrap"><span class="ContactTitleTwoTxt">For Sales!</span><br><span class="CountryText">UK</span><br><span class="CountryDetailsText"><a href="mailto:info@digitology.co.uk">info@digitology.co.uk</a><br>Ph: 02033719214 &nbsp; FAX: 02033719214</span><br><br><span class="CountryText">India</span><br><span class="CountryDetailsText"><a href="mailto:sales@digitology.co.uk">sales@digitology.co.uk</a><br>Ph: +1 (714) 726 2485  &nbsp; Fax: 01279 4208</span></div></div></div></div></div></div>
		...
		<!-- The ribbon -->
		<a id="greenForKit" class="green-forkit" data-text="Contact Us" data-text-detached="Drag down" href="#"><img style="position: absolute; top: 0; right: 0; border: 0;" src="" alt=""></a>
...
<div id="grid-12" class="grid-box landscape" style="z-index: 100; left: 0px; right: 750px; top: 300px; bottom: 0px;"><img src="ThemeGreen/img/img6.jpg" alt="" style="left: -294px; top: -67px;"></div><div id="text-12" class="text-box" style="margin: 28px 0px 0px; left: 0px; right: 750px; top: 0px; bottom: 450px; z-index: 1600; display: none;"><div><h4>Fire Retardant Wires</h4><p>We also manufacture of FRLS - Fire retardant Low Smoke electrical wires. FRLS cables are manufacture by using electrolytic grade copper to ensure superior conductivity. Insulated with a FRLS PVc compound, FRLS has special flame retardant and low smoke emitting properties.</p></div></div>
      ...
      <div class="col-md-5 grid-right wow fadeInRight animated" data-wow-delay="1.6s">
        ...
        <p class="NormalText NormalPcolor">Digitology is a global IT solutions company with over 6 year's experience. We provide full-cycle services in the areas of software development, Web-based enterprise solutions, Web application and portal development. We combine our solid business domain experience, technical expertise, profound knowledge of latest industry trends and quality-driven delivery model to offer progressive, end-to-end Web solutions.</p></div>
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemeGreen/images/Discover.png"></div>
            <div class="HexagonTitle">Discover</div></div><span></span></div>
            <div class="ProcessTextWraper">Lorem Ipsum is simply dummy text of the printing and typesetting industry imply dummy.</div></div></div></div>
            <!--- Pannel End --->
            <!---Pannel -->
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemeGreen/images/Design.png"></div>
            <div class="HexagonTitle">Design</div></div><span></span></div>
            <div class="ProcessTextWraper">Lorem Ipsum is simply dummy text of the printing and typesetting industry imply dummy.</div></div></div></div>
            <!--- Pannel End --->
            <!---Pannel -->
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemeGreen/images/develop.png"></div>
            <div class="HexagonTitle">Develop</div></div><span></span></div>
            <div class="ProcessTextWraper">Lorem Ipsum is simply dummy text of the printing and typesetting industry imply dummy.</div></div></div></div>
            <!--- Pannel End --->
            <!---Pannel -->
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemeGreen/images/deploy.png"></div>
            <div class="HexagonTitle">Deploy</div></div><span></span></div>
            <div class="ProcessTextWraper">Lorem Ipsum is simply dummy text of the printing and typesetting industry imply dummy.</div></div></div></div>
            <!--- Pannel End --->
            <!-- ReadMore --->
           ...
           <div class="grid">
					<figure class="effect-sadie">
						<img src="ThemeGreen/images/DesignServices.jpg" alt="img02" width="100%"/>
						<figcaption>
							<h2><span class="UnderLineHvr">De</span>sign<br>
							<span class="ServicesRegTxt">Losum Dummy, Losum Dummy
</span></h2><p>Custom Graphic Design  - Responsive	PSD to anything - Logos Marketing Materials</p>
					...
					<figure class="effect-sadie">
						<img src="ThemeGreen/images/Develop.jpg" alt="img14" width="100%"/>
						<figcaption>
							<h2><span class="UnderLineHvr">De</span>v<br><span class="ServicesRegTxt">Losum Dummy, Losum Dummy
</span></h2><p>Custom Graphic Design  - Responsive	PSD to anything - Logos Marketing Materials</p>
							<a href="#">View more</a>
                    	...
                    	<figure class="effect-sadie">
						<img src="ThemeGreen/images/DevelopServices.png" alt="img14" width="100%"/>
						<figcaption>
							<h2>Web Application <span class="UnderLineHvr">De</span>v<br>
<span class="ServicesRegTxt">Losum Dummy, Losum Dummy
</span></h2><p>Custom Graphic Design  - Responsive	PSD to anything - Logos Marketing Materials</p>							<a href="#">View more</a>
                    	...
                    	<figure class="effect-sadie">
						<img src="ThemeGreen/images/Dashboard.jpg" alt="img14" width="100%"/>
						<figcaption>
							<h2>Dashboard <span class="UnderLineHvr">De</span>v <br><span class="ServicesRegTxt">Losum Dummy, Losum Dummy
</span></h2><p>Custom Graphic Design  - Responsive	PSD to anything - Logos Marketing Materials</p>
							<a href="#">View more</a>
...
<div class="ContactSubTitleWrap"><span class="ContactTitleTwoTxt">For Sales!</span><br><span class="CountryText">UK</span><br><span class="CountryDetailsText"><a href="mailto:info@digitology.co.uk">info@digitology.co.uk</a><br>Ph: 02033719214 &nbsp; FAX: 02033719214</span><br><br><span class="CountryText">India</span><br><span class="CountryDetailsText"><a href="mailto:sales@digitology.co.uk">sales@digitology.co.uk</a><br>Ph: +1 (714) 726 2485  &nbsp; Fax: 01279 4208</span></div></div></div></div></div></div>
		...
		<!-- The ribbon -->
		<a id="pinkForKit" class="pink-forkit" data-text="" data-text-detached="" href="#"><img style="position: absolute; top: 0; right: 0; border: 0;" src="" alt=""></a>
 ...
 <div class="BtnWraper BtnMargin">
      ...
      <div class="col-md-5 grid-right wow fadeInRight animated" data-wow-delay="1.6s">
        ...
        <p class="NormalText NormalPcolor">Digitology is a global IT solutions company with over 6 year's experience. We provide full-cycle services in the areas of software development, Web-based enterprise solutions, Web application and portal development. We combine our solid business domain experience, technical expertise, profound knowledge of latest industry trends and quality-driven delivery model to offer progressive, end-to-end Web solutions.</p></div>
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemePink/images/Discover.png"></div>
            <div class="HexagonTitle">Discover</div></div><span></span></div>
            <div class="ProcessTextWraper">Lorem Ipsum is simply dummy text of the printing and typesetting industry imply dummy.</div></div></div></div>
            <!--- Pannel End --->
            <!---Pannel -->
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemePink/images/Design.png"></div>
            <div class="HexagonTitle">Design</div></div><span></span></div>
            <div class="ProcessTextWraper">Lorem Ipsum is simply dummy text of the printing and typesetting industry imply dummy.</div></div></div></div>
            <!--- Pannel End --->
            <!---Pannel -->
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemePink/images/develop.png"></div>
            <div class="HexagonTitle">Develop</div></div><span></span></div>
            <div class="ProcessTextWraper">Lorem Ipsum is simply dummy text of the printing and typesetting industry imply dummy.</div></div></div></div>
            <!--- Pannel End --->
            <!---Pannel -->
            ...
            <div class="hexagon">
            <div class="HexagonInnerWraper">
            <div class="HexagonIcon"><img src="ThemePink/images/deploy.png"></div>
            <div class="HexagonTitle">Deploy</div></div><span></span></div>
            <div class="ProcessTextWraper">Lorem Ipsum is simply dummy text of the printing and typesetting industry imply dummy.</div></div></div></div>
            <!--- Pannel End --->
            <!-- ReadMore --->
           ...
           <div class="grid">
					<figure class="effect-sadie">
						<img src="ThemePink/images/DesignServices.jpg" alt="img02" width="100%"/>
						<figcaption>
							<h2><span class="UnderLineHvr">De</span>sign<br>
							<span class="ServicesRegTxt">Losum Dummy, Losum Dummy
</span></h2><p>Custom Graphic Design  - Responsive	PSD to anything - Logos Marketing Materials</p>
					...
					<figure class="effect-sadie">
						<img src="ThemePink/images/Develop.jpg" alt="img14" width="100%"/>
						<figcaption>
							<h2><span class="UnderLineHvr">De</span>v<br><span class="ServicesRegTxt">Losum Dummy, Losum Dummy
</span></h2><p>Custom Graphic Design  - Responsive	PSD to anything - Logos Marketing Materials</p>
							<a href="#">View more</a>
                    	...
                    	<figure class="effect-sadie">
						<img src="ThemePink/images/DevelopServices.png" alt="img14" width="100%"/>
						<figcaption>
							<h2>Web Application <span class="UnderLineHvr">De</span>v<br>
<span class="ServicesRegTxt">Losum Dummy, Losum Dummy
</span></h2><p>Custom Graphic Design  - Responsive	PSD to anything - Logos Marketing Materials</p>							<a href="#">View more</a>
                    	...
                    	<figure class="effect-sadie">
						<img src="ThemePink/images/Dashboard.jpg" alt="img14" width="100%"/>
						<figcaption>
							<h2>Dashboard <span class="UnderLineHvr">De</span>v <br><span class="ServicesRegTxt">Losum Dummy, Losum Dummy
</span></h2><p>Custom Graphic Design  - Responsive	PSD to anything - Logos Marketing Materials</p>
							<a href="#">View more</a>
